...
const Sidebar = ({
  ...
  return (
    <div className="w-full flex flex-col gap-4 lg:gap-6 bg-light-gray rounded-4xl p-4 md:p-6">
      {/* Header */}
      <div className="flex items-center justify-between p-4 md:p-6 bg-#5a5a5a-4xl">
      ...
      <div className="flex flex-col gap-2">
        <button
          ...
          className={`text-center px-4 md:px-6 py-2 md:py-3 font-medium rounded-4xl ${
      ...
      <div className="bg-#5a5a5a-4xl p-6 md:p-8 flex flex-col items-center gap-3 md:gap-4">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="px-5 md:px-6 py-2 bg-gray rounded-2xl text-white font-medium text-sm md:text-base"
          >
            start
          </button>
          <button
      ...
      {/* Points Display */}
      <div className="bg-gradient-to-br from-mango-orange to-strawberry-red rounded-4xl p-10 md:p-12 flex items-center justify-center">
